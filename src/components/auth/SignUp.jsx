...
//             <i className="fa fa-twitter-square" aria-hidden="true"></i>
//             { this.props.auth.signingIn
//               ? <div onClick={(e)=>e.preventDefault()}><i className="fa fa-spinner fa-pulse"></i></div>
//               : <div onClick={this.handleSignUp.bind(this)}>Continue with Twitter</div> }
//           </div>
//
//           <br/>
//
//           <div className="bc-auth-signup-txt">Already a member ?
//             <Link to={"/signup"}><span className="bc-auth-signup-lnk">Sign In</span></Link>
//           </div>
//           </div>
//       </div>
//     </div>
